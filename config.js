...
global.owner = [
  ...
  ['584120346669', 'penesito', true],
  ['573004828388', 'Katsuki bakugo', true] 
];
...
global.vs = '2.1.5'
global.vsJB = '5.0'
global.nameqr = 'Toji Fushiguro-Bot'
global.namebot = 'Toji Fushiguro-bot'
...
global.packsticker2 = `━━━━━━━━♾\n⪛✰ Toji Fushiguro-Bot ✰⪜\nⁱᵃᵐ|Lm Avaricia\n⇝ ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_Angeles').format('HH:mm:ss')} \n°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°\n\nѕτιϲκєя ϐγ: TOJI-FUSHIGURO-BOT`

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packname = `⪛✰ TOJI-FUSHIGURO ✰⪜`
global.botname = 'TOJI-FUSHIGURO-ᑲ᥆𝗍'
global.wm = 'TOJI-FUSHIGURO-BOT'
global.author = 'Made By ⁱᵃᵐ|Lm Avaricia'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ ⁱᵃᵐ|Lm Avaricia'
global.textbot = 'Yυƙι-Sυσυ-Bσƚ • Powered By ⁱᵃᵐ|Lm Avaricia'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'TOJi-FUSHIGURO-Bot︎︎', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
